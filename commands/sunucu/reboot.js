...
message.channel.sendMessage(' ```Botun yeniden başlatılmasına onay veriyorsanız 30 saniye içinde tamam yazın.``` ')
.then(() => {
  message.channel.awaitMessages(response => response.content === "tamam", {
    max: 1,
    time: 30000,
    errors: ['time'],
  })
